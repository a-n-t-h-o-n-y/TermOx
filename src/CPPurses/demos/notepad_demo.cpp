...
int main() {
    ...
    attr_layout.size_policy().horizontal_policy = Size_policy::Fixed;
    attr_layout.geometry().set_width_hint(16);
    ...
    save_area.size_policy().vertical_policy = Size_policy::Fixed;
    save_area.geometry().set_height_hint(1);
    auto& load_btn = save_area.make_child<Push_button>("Load");
    load_btn.size_policy().horizontal_policy = Size_policy::Fixed;
    load_btn.geometry().set_width_hint(6);
    ...
    save_btn.size_policy().horizontal_policy = Size_policy::Fixed;
    save_btn.geometry().set_width_hint(6);
