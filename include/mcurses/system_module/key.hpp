...
enum Key {
	...
	Ctrl_k,					// Vertical Tab
	Ctrl_l,					// Form Feed
	Carriage_return_,		// not used? check with keypad, ascii 13 maybe make it keypad_enter
	Ctrl_n,					// Shift Out
	Ctrl_o,					// Shift In
	...
	Function = 264,	// Add function number to enum when used ex) F5 key = Key::Function + 5;
	...
	Clear_tab,
	Clear_all_tabs,
	Possibly_keypad_enter_, // might be Keypad_enter? check it out, function key and Enter
							// int 343
	Print = 346,
	Home_down, 				// Lower left keypad? Home down key? check with larger keyboard
	Keypad_7,
	Keypad_9,
	Keypad_5,				// other keypad numbers are in arrow keys, make sure this is correct
	Keypad_1,
	Keypad_3,
	Back_tab,
	Begin,
	Cancel_dup_,			// look into this to see if its the same as the above cancel key
	Close,
	Command,
	Copy,
	Create,
