#ifndef SYSTEM_OBJECT_HPP
#define SYSTEM_OBJECT_HPP
...
class Object {
   public:
    ...
    // const std::vector<Object*>& get_event_filters() const {
    ...
    // friend class System;  // TODO Check if this is needed.
   ...
   protected:
    ...
    // std::vector<Object*> event_filters_;
    // bool enabled_ = true;
