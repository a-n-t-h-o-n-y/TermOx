...
class Vertical : public Layout<Child_t> {
   protected:
    void update_geometry() override
    {
        this->enable(true, false);
        auto heights = this->calculate_widget_sizes();
   ...
   private:
        ...
        int height_left)
    {
        ...
        // Calculate new heights of widgets in new group, if any go over
        // max_height then assign max value and recurse without that widget in
        // vector.
        ...
        for (const Dimensions_reference& d : widgets) {
            ...
            if (policy == Size_policy::Expanding ||
                ...
                if ((*d.height + height_additions.back()) >
                    ...
                    height_left +=
                        d.widget->height_policy.max_size() - *d.height;
