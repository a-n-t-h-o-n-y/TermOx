#ifndef CPPURSES_WIDGET_LAYOUT_FIXED_HPP
#define CPPURSES_WIDGET_LAYOUT_FIXED_HPP
#include <cstddef>

#include <cppurses/system/system.hpp>
#include <cppurses/widget/layout/layout.hpp>

namespace cppurse::layout {

/// Fixed offset on left and right sides of Widget_t object.
template <typename Widget_t>
class Fixed_horizontal : public cppurses::Layout {
   public:
...
#endif  // CPPURSES_WIDGET_LAYOUT_FIXED_HPP
