#ifndef CPPURSES_PAINTER_PALETTE_APPLE_II_HPP
#define CPPURSES_PAINTER_PALETTE_APPLE_II_HPP
#include <cppurses/painter/color.hpp>

namespace cppurses::apple_ii {
...
#endif  // CPPURSES_PAINTER_PALETTE_APPLE_II_HPP
