#ifndef CPPURSES_PAINTER_PALETTE_WINDOWS_HPP
#define CPPURSES_PAINTER_PALETTE_WINDOWS_HPP
#include <cppurses/painter/color.hpp>

namespace cppurses::windows {
...
#endif  // CPPURSES_PAINTER_PALETTE_WINDOWS_HPP
