#ifndef CPPURSES_PAINTER_PALETTE_ZX_SPECTRUM_HPP
#define CPPURSES_PAINTER_PALETTE_ZX_SPECTRUM_HPP
#include <cppurses/painter/color.hpp>

namespace cppurses::zx_spectrum {
...
#endif  // CPPURSES_PAINTER_PALETTE_ZX_SPECTRUM_HPP
