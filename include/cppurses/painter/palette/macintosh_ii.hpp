#ifndef CPPURSES_PAINTER_PALETTE_MACINTOSH_II_HPP
#define CPPURSES_PAINTER_PALETTE_MACINTOSH_II_HPP
#include <cppurses/painter/color.hpp>

namespace cppurses::macintosh_ii {
...
#endif  // CPPURSES_PAINTER_PALETTE_MACINTOSH_II_HPP
