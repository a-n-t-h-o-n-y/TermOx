#ifndef CPPURSES_PAINTER_PALETTE_SAVANNA_HPP
#define CPPURSES_PAINTER_PALETTE_SAVANNA_HPP
#include <cppurses/painter/color.hpp>

namespace cppurses::savanna {
...
#endif  // CPPURSES_PAINTER_PALETTE_SAVANNA_HPP
