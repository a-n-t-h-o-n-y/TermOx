#ifndef CPPURSES_PAINTER_PALETTE_WINDOWS_CONSOLE_HPP
#define CPPURSES_PAINTER_PALETTE_WINDOWS_CONSOLE_HPP
#include <cppurses/painter/color.hpp>

namespace cppurses::windows_console {
...
#endif  // CPPURSES_PAINTER_PALETTE_WINDOWS_CONSOLE_HPP
