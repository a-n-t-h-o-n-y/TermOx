#ifndef CPPURSES_PAINTER_PALETTE_AMSTRAD_CPC_HPP
#define CPPURSES_PAINTER_PALETTE_AMSTRAD_CPC_HPP
#include <cppurses/painter/color.hpp>

namespace cppurses::amstrad_cpc {
...
#endif  // CPPURSES_PAINTER_PALETTE_AMSTRAD_CPC_HPP
