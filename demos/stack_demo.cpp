...
int main() {
    ...
    Widget_stack_menu wsm;
    wsm.make_page<Textbox>("Text One", "Textbox 1...");
    wsm.make_page<Textbox>("Text Two", "Textbox 2...");
    wsm.make_page<Textbox>("Text Three", "Textbox 3...");
    wsm.make_page<Textbox>("Text Four", "Textbox 4...");
    wsm.make_page<Textbox>("Text Five", "Textbox 5...");

    Focus::set_focus_to(&wsm);
    set_background(wsm.menu(), Color::Gray);
