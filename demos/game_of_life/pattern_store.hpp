#ifndef CPPURSES_DEMOS_GAME_OF_LIFE_PATTERN_STORE_HPP
#define CPPURSES_DEMOS_GAME_OF_LIFE_PATTERN_STORE_HPP
#include <map>
#include <string_view>
...
#endif  // CPPURSES_DEMOS_GAME_OF_LIFE_PATTERN_STORE_HPP
